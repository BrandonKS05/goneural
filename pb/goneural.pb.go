...
func (x *NeuralNetwork) Reset() {
	*x = NeuralNetwork{}
	if protoimpl.UnsafeEnabled {
		mi := &file_goneural_proto_msgTypes[0]
...
func (*NeuralNetwork) Descriptor() ([]byte, []int) {
	return file_goneural_proto_rawDescGZIP(), []int{0}
}
...
func (x *Layer) Reset() {
	*x = Layer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_goneural_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Layer) Descriptor() ([]byte, []int) {
	return file_goneural_proto_rawDescGZIP(), []int{1}
}
...
func (x *Matrix) Reset() {
	*x = Matrix{}
	if protoimpl.UnsafeEnabled {
		mi := &file_goneural_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Matrix) Descriptor() ([]byte, []int) {
	return file_goneural_proto_rawDescGZIP(), []int{2}
}
...
var file_goneural_proto_rawDesc = []byte{
...
var (
	file_goneural_proto_rawDescOnce sync.Once
	file_goneural_proto_rawDescData = file_goneural_proto_rawDesc
)

func file_goneural_proto_rawDescGZIP() []byte {
	file_goneural_proto_rawDescOnce.Do(func() {
		file_goneural_proto_rawDescData = protoimpl.X.CompressGZIP(file_goneural_proto_rawDescData)
	})
	return file_goneural_proto_rawDescData
}

var file_goneural_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_goneural_proto_goTypes = []interface{}{
	(*NeuralNetwork)(nil), // 0: pb.NeuralNetwork
	(*Layer)(nil),         // 1: pb.Layer
	(*Matrix)(nil),        // 2: pb.Matrix
}
var file_goneural_proto_depIdxs = []int32{
...
func init() { file_goneural_proto_init() }
func file_goneural_proto_init() {
	if File_goneural_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_goneural_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_goneural_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Layer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_goneural_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Matrix); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_goneural_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_goneural_proto_goTypes,
		DependencyIndexes: file_goneural_proto_depIdxs,
		MessageInfos:      file_goneural_proto_msgTypes,
	}.Build()
	File_goneural_proto = out.File
	file_goneural_proto_rawDesc = nil
	file_goneural_proto_goTypes = nil
	file_goneural_proto_depIdxs = nil
}
